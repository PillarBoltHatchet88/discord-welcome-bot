...
> Discord welcome bot, custom messages images role assignment 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

👋 &nbsp;**Custom messages** — personalized welcome text per server

🖼️ &nbsp;**Welcome images** — dynamic images with user avatar and name

🎭 &nbsp;**Auto-roles** — assign roles to new members on join

📬 &nbsp;**DM welcome** — send a private welcome message

🚪 &nbsp;**Leave messages** — notify when members leave

📊 &nbsp;**Member count** — update channel name with live count
